...
*/
// Inicialización de las variables que almacenarán los dos primeros números de la secuencia de Fibonacci.
let a = 0;
let b = 1;
...
function* genFunction() {
  ...
  while (true) {
    ...
    let c = a + b;
    // Actualización de las variables 'a' y 'b' para preparar la generación del siguiente número en la secuencia.
    a = b;
    b = c;
  }
}
